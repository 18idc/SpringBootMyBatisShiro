...
//skin
if (skin) document.write('<link href="' + bootPATH + 'themes/' + skin + '/skin.css" rel="stylesheet" type="text/css" />');

//mode
if (mode) document.write('<link href="' + bootPATH + 'themes/default/' + mode + '-mode.css" rel="stylesheet" type="text/css" />');
